...
[
    ...
    },
    {
        ...
        imgUrl: 'assets/ngsportStore.png',
    ...
    },
    {
        ...
        description: "Contact List app is mean stack contact list management app with user enthentication, and data persistence. The app is developed with angular + nodejs+ expressjs + mongodb",
   ...
   
    {
        ...
        description: "This app is full stack(MEAN) web app the had user interface, admin interface and nodejs-based backend api and uses mongodb for data persistence. The app is simple implementation of the trip advisor webapp, but focus mainly on the customers-reviews management",
        tags:["NodeJS"],
        imgUrl: 'assets/tast.png',
        gitUrl: "https://github.com/donteghen/Restaurant-POS",
        videoID : "7YSiG5zpUH4M"
    },
    {
        id: "0cd6c9ab-ff25-439e-b456-fdbac8a41b65",
        title: "Photo Gallery",
        description: "Personal photo gallery test app developed with ionic4, capacitor and Angular. With this app, a user can create a person in-app photo catalog. The app also provides a deleted and add more photo options.",
    ...
    },
    {
        ...
        title: "Le Journal",
        description: "Hacker new app is hot new feed app that allows to stay upated with latest tech related news and also provides an externally links to the original source of the articles. Users can subscript to get a user-dependent custom content. The app contains all the nested comments which can also be read if desired. Th app is made with angular-ionic4 + cordova and firebase.",
        tags:["Ionic", "Angular", "Cordova", "Firebase"],
    ...
    },
    {
        ...
        title: "Coin Mining",
        description: "A candycrush-like cross-platform app developed with qt & qt5 + javascript + felgo game engine. The app is animation rich, sound and effects integrated and intelligent suggestio on next move. ",
    ...
    },
    {
        ...
        description: "Restaurant on-spot order management system developed with locally managed authentication, inventory management, and customer order management. This project is built with c# .NET webforms, EF6 and MSSQL.",
    ...
    },
    {
        ...
        imgUrl: 'assets/react+apollo.png',
